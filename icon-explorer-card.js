  ...
  static getConfigForm() {
    return {
      schema: [
        ...
        { name: "columns", selector: { number: { min: 2, max: 20, step: 1 } } },
        { name: "icon_size", selector: { number: { min: 12, max: 96, step: 4 } } },
        { name: "show_names", selector: { boolean: {} } },
        { name: "page_size", selector: { number: { min: 10, max: 500, step: 10 } } },
      ],
    };
  }
